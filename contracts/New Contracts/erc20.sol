...
contract Vittagems is ERC20, ERC20Pausable, ERC20Burnable, AccessControl, ERC20Permit {
    ...
    /// @dev Deployment flow: deploy Vittagems → deploy DOVGovernance → call this → call lockReserveOracle()
    ...
    function mint(address to, uint256 amount) public onlyRole(MINTER_ROLE) {
        ...
        // Enforce 1:1 reserve backing — total supply must never exceed reserve value
